        ...
        <div className="glass-card contact__card fade-in-up">
          ...
          <div
            style={{
              ...
              background: 'linear-gradient(90deg, var(--c-accent), var(--c-glow), var(--c-pulse))',
          ...
          <p className="contact__body">
            Whether you have a question about my projects, want to discuss web development, or just want to say hi — I&apos;m all ears.
          </p>
